...
<form action="login1.php" method="post" onSubmit="return check();">
...
<div><span id="onvan">ایمیل شما:<b id="onvan" style="color:red;">*</b></span><input type="text"  name="email"></div>


<div><span id="onvan">رمز عبور:<b id="onvan" style="color:red;">*</b></span><input style="direction:ltr;" type="text" name="pass"></div>
...
<div><span id="onvan">مرا به خاطر داشته باش:</span><input type="checkbox" name="remember"></div>
